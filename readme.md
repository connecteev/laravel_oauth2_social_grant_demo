...
GITHUB_REDIRECT_URL=http://localhost:3000/auth/socialCallback/github 
(or whatever your callback URL will be)
...
Note: Steps 5-8 can be wrapped into one Laravel endpoint, so that:
